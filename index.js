 ...
 * CommonJS to support Node (11ty) and Obsidian (bundled CJS).
 */
...
function calculateSimilarities(items, options) {
  ...
  /** @type {Record<string, Array<{ id: string, title: string, similarity: number }>>} */
  const similarities = {};
 ...
 */
function vectorizeDocuments(docs, options) {
